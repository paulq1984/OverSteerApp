        ...
        if persistedTeams.isEmpty {
            ...
            if !teams.isEmpty {
                teams.forEach{ team in
                    let teamModel = TeamModel(id: team.id, name: team.name, logo: team.logo, constructor: team.constructor, chassis: team.chassis, power_unit: team.power_unit, base: team.base, tp: team.tp, team_url: team.team_url)
